...
bool InitApp()
{
    ...
    char *temp = "C:\\Users\\chris\\Desktop\\Jumping_Ball\\Jumping_Ball_VS\\fonts\\Montserrat-VariableFont_wght.ttf";
	...
	{
		printf("Failed to open font because: ");
		printf("%s\n", TTF_GetError());
		return false;
	}
